...
namespace BB
{
    public static class EditorGuiUtils
    {
        ...
        public static string Dropdown<T>(string element, List<T> list, Func<T, string> getName,
            params GUILayoutOption[] lops)
        {
        ...
        public static bool Toggle(string name, bool value)
            =>GUILayout.Toggle(value, name, GUI.skin.button);
        ...
        public static bool Foldout(object obj) => Foldout(null, obj);
